...
**EN:** 3 fish mesh variants (144 / 42 / 21 faces) selected per boid by distance to camera. Instead of drawing 144-face fish everywhere, distant boids use the 21-face version.

**JP:** 魚メッシュを 3 種類 (144 / 42 / 21 面) 用意。カメラからの距離で選ぶ。遠い魚は 21 面の軽い版。
